...
\begin{center}
\includegraphics[width=.9\linewidth]{/Volumes/f/kcwang/pic/readme_20210507_172159.png}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{/Volumes/f/kcwang/pic/readme_20210507_172332.png}
\end{center}

尖人说他完全没有把那件事放心上，不相信我会做出过激行为。

\begin{center}
\includegraphics[width=.9\linewidth]{/Volumes/f/kcwang/pic/readme_20210507_172415.png}
\end{center}
...
\label{sec:org335759b}

\subsection{秋天的学费要怎么办呢}
\label{sec:orga2f620b}
...
\label{sec:org120e39e}

\subsection{（一）毕业后的去向}
\label{sec:org91e6f61}

...
\label{sec:org8af04bb}
\subsection{（四） 崩溃瞬间}
\label{sec:org034c921}
...
\subsection{（七） 考试成绩}
\label{sec:org9fef201}
\subsection{（八） 其它}
\label{sec:org0ea9f56}

\section{行走在《计算机》专业的大道上（3）——第二学期}
\label{sec:org07760f0}
  \textbf{备注：}

...
《小弱弱》的内容还没有完全写完，剩一小半，改天有机会需要的时候再与其它内容平行、作为一天两篇中的一篇（另一篇应该是学习或工作相关的）来写

尘世中将就过的婚姻已经走到了尽头、再无任何回旋的余地

今晚开始写，看明天能否把《那注定破裂、将就过的尘世婚姻》发上来

这个周末把申请WSU学校的《Statement of Purpose》写出来，这个周末把申请WSU学校的网页全部填完

\section{小弱弱躲猫猫记（1）: 青梅竹马（属马白羊座）}
\label{sec:org0575bfe}

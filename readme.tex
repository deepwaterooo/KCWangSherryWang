...
\label{sec:orgd00542f}
\subsection{（五） 专业上的小信心}
\label{sec:org78c7b48}
\subsection{（六） 亲情爱情}
\label{sec:org5ac5728}
\subsection{（七） 考试成绩}
\label{sec:org8977613}
\subsection{（八） 其它}
\label{sec:org908056a}

\section{行走在《计算机》专业的大道上（3）——第二学期}
\label{sec:org9354897}
  \textbf{备注：}

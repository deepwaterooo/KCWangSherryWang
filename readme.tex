...
\label{sec:org210ce80}
\subsection{（四） 崩溃瞬间}
\label{sec:org8f6208c}
\subsection{（五） 专业上的小信心}
\label{sec:org6fa252d}
\subsection{（六） 亲情爱情}
\label{sec:org74f02c4}
\subsection{（七） 考试成绩}
\label{sec:org2917f24}
\subsection{（八） 其它}
\label{sec:orgbfa7105}

\section{行走在《计算机》专业的大道上（3）——第二学期}
\label{sec:org204babd}
  \textbf{备注：}

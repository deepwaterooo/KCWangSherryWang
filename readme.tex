...
\label{sec:orge0707a6}

\subsection{秋天的学费要怎么办呢}
\label{sec:orgfe2279e}
...
\subsection{装蒜的青葱岁月：小弱弱心智成长（小弱弱躲猫猫记【续】）}
\label{sec:org52bae9c}
...
而这个当初的朋友，大概一如我后来死在不读什么狗屁的屁挨着地（Ph.D），对于我这种一直傻读书的傻子，是怎么也看不入眼的吧，她也嘲笑嘲笑我：
...
那年冬天记忆就只有那么多了。春天里，随着学校食堂里弄出的事情多起来，我的小心脏终于快要承受不住、濒临于崩溃边缘，每每灵魂出窃儿，关键时候又总有一个神奇的力、外力将自己支撑住。
...
今天会把这篇第二学期写完写完整，会再提交到改好为止，会再多提交一两次

\section{我最亲爱的表哥（3）}
\label{sec:org036f7d9}
...
\label{sec:orgc3b39c5}

\subsection{（一）毕业后的去向}
\label{sec:org82220d0}

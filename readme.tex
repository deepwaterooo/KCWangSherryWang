...
而现在当我一边学习一边要在学校食堂打工，我表哥都清瘦得让我心疼——实在我表哥应试是心里也很心疼当年我不得不面对的自己的成长吧！是苦是惹人心疼，可那也是她的人生，是她成长必须要付出的代价呀。 

不记得从哪里读到的了，爱你的人会用你喜欢的方式来爱你。这里，我表哥的表现方式就是他把自己变成了我的镜子。从我表哥身上我可以看见自己的向往与成长。
...
我总是想念与我表哥相处的那个万赖俱静的夜晚！

当时幼稚的自己或许还在期待着我表哥能够先说点儿什么（承诺啊、或者至少承认喜欢我吧），不知道该如何行为、也不敢付出行动。可是接下来的日子里，多年以后，每每想起我表哥，情不自禁，总是每每遗憾：当年的自己为什么说法那么胆小？就不说别的，至少稍微亲密一点儿的行为：亲吻、抚摸、拥抱那个时候都是可以有的呀，再剩下的就顺其自然不就好了？！！！

可是像那个万赖俱静的夜晚的机会总不再有，我亲爱的表哥与我这里就留下那个永远的遗憾！好在，我亲爱的表哥与我总还是会再走到一起，总还会再有那一天的！！！
...
\label{sec:orgb008d10}

\subsection{秋天的学费要怎么办呢}
\label{sec:org792025c}
...
\label{sec:orgafad9d0}

\subsection{（一）毕业后的去向}
\label{sec:org2e4b5b0}

...
\begin{center}
\includegraphics[width=.9\linewidth]{/Volumes/f/kcwang/pic/backups_plans_20210425_125121.png}
\end{center}
...
学校里的第一个学期，班上只我与我另一女生两个女孩。另一个她还比较年轻，二十出头吧，有点儿混血，有点儿另类，有点儿哗众取宠。
...
\label{sec:org2a5cb37}
\subsection{（五） 专业上的小信心}
\label{sec:org277ab86}
\subsection{（六） 亲情爱情}
\label{sec:org7491230}
\subsection{（七） 考试成绩}
\label{sec:orgfba7e67}
\subsection{（八） 其它}
\label{sec:org524e9db}

\section{行走在《计算机》专业的大道上（3）——第二学期}
\label{sec:orgb7099eb}
  \textbf{备注：}

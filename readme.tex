...
这最近几年的思想、想法都列在这个subversion里，我无意刻意去隐瞒什么。 
...
后来2015年听表姐反应，这个管理者也离开了，调去了其它公司。他——一个高层的管理者，也是三大中文逼良为娼产业最内部的精英吗？应该是她负责安排和解决了大表姐王夏华在硅谷职场最终的生存问题——三星公司于2014年秋天我写出一年前实习传记、三大再加热炒炒出舆论效应后，给拔苗助长、特意安排了一次出差加持机会，并给办了工作绿卡。这些是后话。 
...
对一个留学生女性将来生存空间的恶意封锁（被逼作性奴之间）与解禁（被逼成就犯、甘当性奴之后）、三在中文媒体舆论，它们可以做到：翻手为云、覆手为雨，为所欲为，全在他们一念之间！！！
...
左错右错、千错万错，都是你一个人的错，你——不能胜任你的工作、你——不能处理好工作时与自己的导师mentor senior长老B的关系，而迫使公司里——不得不——为你更换一个实习导师，你这个麻烦事端制造者！！！
...
今天暂时更新写到这里，也已经写了7页了。接下来我自己也会看场球赛几个小时，等球赛结束后，剩下的内容可能会再更新一次吧
...
\label{sec:orgf5edbca}

\subsection{秋天的学费要怎么办呢}
\label{sec:orgca9241a}
...
\label{sec:org711fb2c}

\subsection{（一）毕业后的去向}
\label{sec:org6b35c08}

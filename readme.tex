...
前面不是说了吗？我亲爱的表哥这么优秀、而我自己又是那么一个还有着少妇心的小弱弱，前有六年级时孩童时期青梅竹马被问破时自己的尴尬
...
但后来因为与表哥关系的临时慌乱，一个多月前的三月底，我还是回了一趟当初的小镇，只是还是不曾再踏入那个校园半步。
...
我想说的是：真的永无出头之日！真的会被他们彻底给搞死的！

\begin{center}
\includegraphics[width=.9\linewidth]{./pic/backups_plans_20210424_092841.png}
\end{center}

与其如此，不如360行，行行出状元，坚守自己原本的专业，把自己打造成精英，也是一种很好的活法。

\section{行走在《计算机》专业的大道上（2）}
\label{sec:org6677198}

\section{盘旋在校园上空的三大舆论“监控”力量}
\label{sec:org91d531f}

\textbf{备注：}

尘世将就过的婚姻的部分只写了一半，还没写完，可能今天晚时候或者明天才发出来

回到学校的内容一时半会儿还是不知道怎么写怎么立意，先尝试着写这一个学期、或是第一年的环境感受、学习成长，感觉一下，再去看是否先写夏天实习（感觉这么写更自然一些），还是把计算机专业写完

因为后来情商回来稍高一点儿，很多事情都被如实记载过，一方面我会努力再写得稍微深一点儿（以事后诸葛亮、过来人的眼光回望那一段风雨兼程），另一方面可能也只能借助谋篇组篇重新组合才能读起来连贯有感觉，所以接下来的内容、绝大部分的内容可能都会被打乱顺序与重新组篇，个别需要时间连贯的除外。

这个先尝试一两篇，感觉一下，看接下来该如何提升写法。

\section{成长的故事 -- 我和表哥}
\label{sec:org4cd82e6}
\begin{itemize}

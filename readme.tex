...
\label{sec:org52c0a0d}
\subsection{（四） 崩溃瞬间}
\label{sec:org204bcb0}
...
\subsection{（六） 亲情爱情}
\label{sec:org4427ae1}
\subsection{（七） 考试成绩}
\label{sec:org04e10e9}
\subsection{（八） 其它}
\label{sec:org02e825a}

\section{行走在《计算机》专业的大道上（3）——第二学期}
\label{sec:orge6a7c9e}
  \textbf{备注：}

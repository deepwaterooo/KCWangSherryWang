...
\label{sec:orgc3b72cb}

\subsection{秋天的学费要怎么办呢}
\label{sec:org4b300ea}
...
这几天身体不太好，精力不够、写得不好，也没有条理，今天的内容也还是没有再写完。今天不会更新了

今晚会打一下明天的草稿，明天先写一个夏天实习的初始阶段，并把今天剩下没有组装好的内容组装好写完，明天中午12:00前先提交一次，剩下的明天下午什么时候写完再提交一次

周四或最迟周五把接下来13年春天、把与表哥的这个短暂结局（一年临时令）补完；

\section{我最亲爱的表哥（3）}
\label{sec:orgca51c13}
...
\label{sec:orgb77094c}

\subsection{（一）毕业后的去向}
\label{sec:org6f28cca}

...
我们实习生在组长C这里是空气是风，至于这岁刮过没有，组长C都是不care的。我们实习生——更确切地说，我的存在感，是在一开始就被这个公司、这个小组编定为0的。
...
不一定是为自己争credit吧，更多的可能是为自己争一份存在感。会议结束后，我在长老B的位置上指出了她代码里存在的这个bug。但事后表姐却批评了我。 
...
\label{sec:org57749ce}

\subsection{秋天的学费要怎么办呢}
\label{sec:orgd601541}
...
\label{sec:orge346b2f}

\subsection{（一）毕业后的去向}
\label{sec:org18fbd58}
